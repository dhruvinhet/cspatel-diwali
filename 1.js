const wishes = [
  ...
  wishesButton.addEventListener("click", function() {
    ...
    wishesElement.innerHTML = `<span style="color: white; font-size: 1.5em;text-shadow: 0 0 5px #00ff40, 0 0 10px #00ff40, 0 0 15px #00ff40;">Happy Diwali, ${name}! ${randomWish}</span>`;
  });
